...
PEP_In = open('./E-coli/Escherichia_coli_PEP.fa_CD_c90_s60.clstr','r')
StORF_In = open('./E-coli/Escherichia_coli_PEP_Clustered_With_Unclustered_UR-StORFs.fa_CD_c90_s60.clstr','r')
